...
import getTimelineObjects from '@salesforce/apex/ObjectTimeline_Controller.getTimelineObjects';
import newObj from '@salesforce/label/c.ObjectTimeline_New';

export default class ObjectTimelineNewObject extends NavigationMixin(LightningElement) {
    @api recordId;
    @api configId;
    ...
    createRecord(event) {
        ...
        if (formFactorPropertyName !== 'Small') {
            ...
            this[NavigationMixin.Navigate]({
                ...
                attributes: {
                    objectApiName: row.Object_Timeline_Child__r.SObjectName__c,
                    actionName: 'new'
                },
                state: {
                    nooverride: override,
                    recordTypeId: row.Object_Timeline_Child__r.CreateableObject_RecordType__c,
