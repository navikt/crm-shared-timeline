...
const getFieldValues = (row, recordId) => {
    ...
    let type = getKeyAndValueIfValid(
        row.Object_Timeline_Child__r.SObjectTypeField__c,
        row.Object_Timeline_Child__r.SObjectTypeValue__c
    );
    if (type !== null) {
        fields.push(type);
    }
    ...
    let val1 = getKeyAndValueIfValid(
        row.Object_Timeline_Child__r.CreateableObject_Field1__c,
        row.Object_Timeline_Child__r.CreateableObject_Value1__c
    );
    if (val1 !== null) {
        fields.push(val1);
    }
    ...
    let val2 = getKeyAndValueIfValid(
        row.Object_Timeline_Child__r.CreateableObject_Field2__c,
        row.Object_Timeline_Child__r.CreateableObject_Value2__c
    );
    if (val2 !== null) {
        fields.push(val2);
    }
    ...
    let val3 = getKeyAndValueIfValid(
        row.Object_Timeline_Child__r.CreateableObject_Field3__c,
        row.Object_Timeline_Child__r.CreateableObject_Value3__c
    );
    if (val3 !== null) {
        fields.push(val3);
    }
