...
import getTimelineObjects from '@salesforce/apex/ActivityTimeline_Controller.getTimelineObjects';
import newObj from '@salesforce/label/c.ActivityTimeline_New';

export default class ActivityTimelineNewObject extends NavigationMixin(LightningElement) {
    @api recordId;
    @api configId;
    ...
    createRecord(event) {
        ...
        if (formFactorPropertyName !== 'Small') {
            ...
            this[NavigationMixin.Navigate]({
                ...
                attributes: {
                    objectApiName: row.Activity_Timeline_Child__r.SObjectName__c,
                    actionName: 'new'
                },
                state: {
                    nooverride: override,
